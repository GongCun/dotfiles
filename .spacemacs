...
values."
  ...
  (setq-default
   ...
   dotspacemacs-default-font '("Unicode"
                               :size 13
                               :weight normal
                               :width normal
                               :powerline-scale 1.1)
