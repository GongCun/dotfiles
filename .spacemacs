...
values."
  (setq-default
   ...
   dotspacemacs-additional-packages '(markdown-mode markdown-toc smex vimish-fold evil-vimish-fold htmlize)
...
you should place your code here."
  ...
  ;; I don't know how to fix the loading error in path 'layers/+lang/graphviz',
  ;; so I load-path from the private directory.
  (load-file "~/.emacs.d/private/local/graphviz-dot-mode.el")
